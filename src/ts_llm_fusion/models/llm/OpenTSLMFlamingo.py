...
from src.ts_llm_fusion.models.encoder.CNNTokenizer import CNNTokenizer, WaveletTokenizer
...
class WaveletOpenTSLMFlamingo(TimeSeriesLLM):
    def __init__(
        self,
        device: str,
        ...
        **flamingo_kwargs,
        ...
        time_series_encoder = WaveletTokenizer().to(device)
